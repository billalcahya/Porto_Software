...
export function ShaderBackground() {
  return (
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div className="orb-glow w-lg h-128 bg-lime-400/25 top-1/3 right-5 animate-pulse" />

      {/* Floating Electric Blue Ambient Orb */}
      <div className="orb-glow w-md h-112 bg-blue-500/25 bottom-20 left-1/4" />

      {/* Floating Violet Accent Orb */}
      <div className="orb-glow w-[24rem] h-96 bg-purple-500/20 top-2/3 right-1/3" />
    </div>
  );
}
