...
export function FigmaIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M12 12A3 3 0 1 0 12 6a3 3 0 0 0 0 6zm0 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm-6 0a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm0 0a3 3 0 0 0 3 3 3 3 0 0 0 3-3H6zm12-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
    </svg>
  );
}
